A_AnimationSystem = class("A_AnimationSystem",System)

function A_AnimationSystem:start(actors)
...
function A_AnimationSystem:SetFrame(compo_Animate)
...
function A_AnimationSystem:update(dt,actors)
    local actors = actors or {};
    if not next(actors) then 
        return 
    end
...
function A_AnimationSystem:draw(actors)
    local actors = actors or {};
    if not next(actors) then 
        return 
    end
...
function A_AnimationSystem:Play(actor,nStartFrame,nEndFrame,fComplete)
	if not actor then 
		return;
	end
	local compo_Animate = actor:GetCompo("Animate");

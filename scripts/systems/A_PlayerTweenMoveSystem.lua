A_PlayerTweenMoveSystem = class("A_PlayerTweenMoveSystem",System)


function A_PlayerTweenMoveSystem:start() 
    self.tbPath = nil;  
...
function A_PlayerTweenMoveSystem:SearchPathComplete(tbPath,pfn)
    self.tbPath = tbPath;
    self.pfn = pfn;
...
function A_PlayerTweenMoveSystem:MoveHandler(iTargetNode)
...
function A_PlayerTweenMoveSystem:GetNextNode()

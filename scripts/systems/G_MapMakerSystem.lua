G_MapMakerSystem = class("G_MapMakerSystem",System)

function G_MapMakerSystem:start() 
...
function G_MapMakerSystem:GetSameItem(tbDataMapInfo,tbNode)
...
function G_MapMakerSystem:draw()
    local iMap = actmgr:GMap();
    local iMapCompo = iMap:GetCompo("MapMaker").data;

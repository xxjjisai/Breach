AstarSystem = class("AstarSystem",System)

function AstarSystem:start()
...
function AstarSystem:GetNeighbors(iNode)
    return iNode.tbNeighors;
end

function AstarSystem:AddNeighbors(iNode,tbRealMapInfo)
    local x = iNode.x ;
    local y = iNode.y ;

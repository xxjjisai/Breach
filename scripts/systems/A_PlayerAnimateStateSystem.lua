A_PlayerAnimateStateSystem = class("A_PlayerAnimateStateSystem",System)

function A_PlayerAnimateStateSystem:start()
    Event:AddEvent(sysmgr:GetSystem("A_WASDMoveSystem"),self);
    -- Event:AddEvent(sysmgr:GetSystem("A_PlayerTweenMoveSystem"),self);
end

function A_PlayerAnimateStateSystem:EvtPlayerWASDMove(actor,sState,nState)
